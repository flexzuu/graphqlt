// Package graphqlt provides a low level GraphQL client.
//
//  // create a client (safe to share across requests)
//  client := graphqlt.NewClient("https://machinebox.io/graphql")
//
//  // make a request
...
//  client := graphqlt.NewClient("https://machinebox.io/graphql", graphqlt.WithHTTPClient(httpclient))
package graphqlt
